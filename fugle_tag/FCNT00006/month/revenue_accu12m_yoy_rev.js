...
request(url).then(function(data){
    ...
    revenue_accu12m_yoy_rev(container, undefined, undefined);
});

var revenue_accu12m_yoy_rev = function(container, previousTag, option){
    var accu12m_now = 0;
    var accu12m_last = 0;
    var judge = undefined;
    if((container.rawContent).length < 24){
        ...
        judge = false;
        rate = 1- (accu12m_now/accu12m_last);
...
module.exports={judge : revenue_accu12m_yoy_rev};
