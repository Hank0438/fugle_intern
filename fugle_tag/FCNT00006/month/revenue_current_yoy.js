...
if(require.main === module){
    request(url).then(function(data){
        ...
        container.rawContent.forEach(function(content){
            var res = revenue_current_yoy(content, undefined, undefined);
            console.log(res);
        });
    });
}

var revenue_current_yoy = function(content, previousTag, option){
    ...
    return {
        ...
        type : "revenue_current_yoy",
        tag_value : {'tag' : current_yoy},
        data_value : {}
    };
};

module.exports={judge : revenue_current_yoy};
