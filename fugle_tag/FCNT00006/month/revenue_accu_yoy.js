...
if(require.main === module){
    request(url).then(function(data){
        ...
        container.rawContent.forEach(function(content){
            var res = revenue_accu_yoy(content, undefined, undefined);
            console.log(res);
        });
    });
}

var revenue_accu_yoy = function(content, previousTag, option){
    ...
    return {
        ...
        type : "revenue_accu_yoy",
        tag_value : {'N' : accu_yoy},
        data_value : {}
    };
};

module.exports={judge : revenue_accu_yoy};
