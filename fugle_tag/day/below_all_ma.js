...
var below_all_ma = function( content, previousTag, option ){
...
var judge = function(pre_data_value, current_data_value){
    ...
    var over_2percents_pre_close = current_data_value.close < pre_data_value.close*0.98;
    var in_10percents_ma = current_data_value.close > current_data_value.ma5*0.9 && 
                    current_data_value.close > current_data_value.ma10*0.9 &&
                    current_data_value.close > current_data_value.ma20*0.9 &&
                    current_data_value.close > current_data_value.ma60*0.9;
...
var res = below_all_ma( undefined, default_tag, undefined);
console.log(res);
