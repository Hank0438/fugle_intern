...
function tw50() { // 台灣50權值股
    fs.readFileAsync('C:/Users/USER/Desktop/Fugle/tw50_s1.json').then((stock) => {
        var output = [];
        ...
        arr.forEach((company) => {
            ...
            request(url).then((data) => {
                ...
                console.log(single);
                output.push(single);
                fs.writeFileSync(`period${param.period}_buyday${param.buyDay}.json`, JSON.stringify(output, null, 4));
            });
        });
    });
}
